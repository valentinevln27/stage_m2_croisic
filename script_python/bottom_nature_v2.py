...
"""
This script processes a shapefile containing spatial data about bed materials 
and classifies different substrate types into three broad categories. It then 
counts the number of polygons belonging to each category.
"""
