# -*- coding: utf-8 -*-
"""
Created on Wed Apr 30 15:53:13 2025
...
for i, (lat, lon) in enumerate(zip(gdf_points['lat'], gdf_points['lon'])):
    ...
    low_pressure_events = df_patm[df_patm['Patm'] < 98000]
    # Create windows around low-pressure events using surrounding maxima
    storm_windows2 = create_maximas_windows(df_patm, low_pressure_events, 98000)
    ...
    if len(storm_windows) < 500 : # May need adjustment depending on the threshold
        print('Next')
