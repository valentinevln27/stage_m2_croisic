...
"""
This script trims a .slf layer from a mesh whose nodes contain bathymetry values. Thus, when 
the bathymetry value of a point exceeds a defined maximum value, it is replaced by this 
maximum value.
"""
