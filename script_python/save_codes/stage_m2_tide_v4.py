# -*- coding: utf-8 -*-
"""
Created on Wed May 21 10:46:46 2025
...
type = 'harmo' # 'combi' or 'compa' or sensi
mesh = '1.3' # if type = 'sensi', can be '1.1' or '1.2' or '1.3' or '1.3_test'
MAE = [] 
RMSE = []
PBIAIS = [] 
for i in range(1, 7):
    ...
    if type == 'sensi':
        ...
        file_path_pt = f'../bluekenue_stage/point/{type}_point_v{ver}/ks{ks}_v{ver}/point_{i}_ks{ks}_{type}_v{ver}.ts1'
    elif type == 'harmo':
        file_path_pt = f'D:/r2dCroisicHarmonics/harmo_points/point_{i}_harmo.ts1'
    else: 
        file_path_pt = f'../bluekenue_stage/point/{type}_point_v{ver}/ks{ks}_v{ver}/point_{i}_ks{ks}_v{ver}.ts1'
