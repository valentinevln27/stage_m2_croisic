...
Dans le dossier [records](https://github.com/valentinevln27/stage_m2_croisic/tree/main/data_stage_m2/records) se trouve deux dossiers, inputs et outputs, ainsi qu'un fichier excel, [data_prediction_all](https://github.com/valentinevln27/stage_m2_croisic/tree/main/data_stage_m2/records/data_prediction_all.xlsx). Ce 
Le dossier [inputs](https://github.com/valentinevln27/stage_m2_croisic/tree/main/data_stage_m2/records/inputs) de records, contient les prédictions marégraphiques (en m) organisées par tempête pour chacun des marégraphes.
